...
public class EliminarFila {
    ...
    public void EliminarLineaCompletaConPiezasEspecificas() {
        ...
        // Dog
        assertEquals(0, board.getCelda(18, 0), "Dog debe ocupar (18,0)");
        assertEquals(0, board.getCelda(18, 1), "Dog debe ocupar (18,1)");
        assertEquals(1, board.getCelda(19, 1), "Dog debe ocupar (19,1)");
        assertEquals(1, board.getCelda(19, 2), "Dog debe ocupar (19,2)");

        // Stick horizontal (apilado en fila 18)
        assertEquals(0, board.getCelda(18, 2), "StickH debe ocupar (18,2)");
        assertEquals(0, board.getCelda(18, 3), "StickH debe ocupar (18,3)");
        assertEquals(0, board.getCelda(18, 4), "StickH debe ocupar (18,4)");
        assertEquals(0, board.getCelda(18, 5), "StickH debe ocupar (18,5)");

        // Square
        assertEquals(0, board.getCelda(18, 6), "Square debe ocupar (18,6)");
        assertEquals(0, board.getCelda(18, 7), "Square debe ocupar (18,7)");
        assertEquals(1, board.getCelda(19, 6), "Square debe ocupar (19,6)");
        assertEquals(1, board.getCelda(19, 7), "Square debe ocupar (19,7)");

        // Stick vertical en columna 8
        assertEquals(0, board.getCelda(16, 8), "StickV1 debe ocupar (16,8)");
        assertEquals(1, board.getCelda(17, 8), "StickV1 debe ocupar (17,8)");
        assertEquals(1, board.getCelda(18, 8), "StickV1 debe ocupar (18,8)");
        assertEquals(1, board.getCelda(19, 8), "StickV1 debe ocupar (19,8)");

        // Stick vertical en columna 9
        assertEquals(0, board.getCelda(16, 9), "StickV2 debe ocupar (16,9)");
        assertEquals(1, board.getCelda(17, 9), "StickV2 debe ocupar (17,9)");
        ...
        // Verifica que la fila 18 esté vacía después de eliminar
    }
}
